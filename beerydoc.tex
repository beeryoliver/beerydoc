...
Version 0.0.0\quad 23 June 2026
...
This class makes \texttt{\string|} an active character, a shortcut for
verbatim.
Within verbatim, spaces are replaced by \cs{textvisiblespace}.
...
\begin{code}{\key}
  ...
  \meta{key-value list} sets the keys in path |key| for only that particular
  usage of \cs{key}.
\end{code}
